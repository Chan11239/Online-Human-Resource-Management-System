...
{
    public partial class COEMultiPurpose : AbstractWebPage
    {
        ...
        private void populateResignationApplication(int id)
        {
            ...
            if (COErequest != null)
            {
                EmployeeDetail employeeDetail = employeeDetailService.find(COErequest.employeeNo);
                if (employeeDetail != null)
                {
                    ...
                    lblSalary.Text = employeeDetail.salaryRate.ToString();
