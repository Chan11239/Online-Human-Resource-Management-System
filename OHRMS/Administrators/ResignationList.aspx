<%@ Page Title="" Language="C#" MasterPageFile="~/Helpers/Administator.Master" AutoEventWireup="true" CodeBehind="ResignationList.aspx.cs" Inherits="OHRMS.Administrators.ResignationList" %>
            ...
            <div class="col">
                <div class="card mt-2">
                    <div class="card-header">
                        <h4>Submitted Resignation Forms</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col"></div>
                        ...
                        <div class="row">
                            <div class="table table-responsive">
                                <asp:GridView ID="gvResignationApplication" runat="server" AutoGenerateColumns="false" CssClass="table table-hover border">
                                    <Columns>
                                        <asp:BoundField DataField="employeeNo" HeaderText="Employee No." />
                                        <asp:BoundField DataField="employeeName" HeaderText="Employee Name" />
                                        <asp:BoundField DataField="message" HeaderText="Reason for" />
                                        <asp:BoundField DataField="effectivityDate" HeaderText="Effectivity" />
