<%@ Page Title="" Language="C#" MasterPageFile="~/Helpers/Administator.Master" AutoEventWireup="true" CodeBehind="EmployeeTimesheet.aspx.cs" Inherits="OHRMS.Administrators.EmployeeTimesheet" %>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="md-form input-group mb-3">
                                    <asp:TextBox ID="txtEmployeeNo" runat="server" required="true" CssClass="form-control"></asp:TextBox>
                                    <label class="mb-0 ml-2" for="txtEmployeeNo">Employee No</label>
                                </div>
                            </div>
                            <div class="col">
                                <div class="md-form input-group mb-3">
