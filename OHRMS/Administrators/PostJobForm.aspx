<%@ Page Title="" Language="C#" MasterPageFile="~/Helpers/Administator.Master" AutoEventWireup="true" CodeBehind="PostJobForm.aspx.cs" Inherits="OHRMS.Administrators.PostJobForm" %>
            ...
            <div class="col">
                <div class="card mt-2">
                    <div class="card-header">
                        <h4>Post A Job<span class="text-danger muted align-top small">New</span></h4>
                    </div>
                    <div class="card-body">
                        <div class="row mb-5">
                            <div class="col text-center">
                                <h5>Tell Someting About the Job</h5>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col">
                            ...
                            <div class="col">
                                <div class="form-group"><label class="active"><span class="text-danger">* </span>Department</label>
                                    <asp:DropDownList ID="ddlDepartment" runat="server" CssClass="mdb-select md-form" AutoPostBack="true" OnSelectedIndexChanged="ddlDepartment_SelectedIndexChanged">
                                        <asp:ListItem Value="-" Text="- Select -"></asp:ListItem>
                                    </asp:DropDownList>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <div class="form-group"><label class="active"><span class="red-text">* </span>Position</label>
                                    <asp:DropDownList ID="ddlPosition" runat="server" CssClass="mdb-select md-form">
                                        <asp:ListItem Value="-" Text="- Select -"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlQualification" runat="server" CssClass="mdb-select md-form">
                                        <asp:ListItem Value="-" Text="- Select -"></asp:ListItem>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                <div class="md-form md-outline input-with-post-icon datepicker">
                                    ...
                                    <asp:TextBox ID="txtDurationDate" runat="server" TextMode="Date" CssClass="form-control" type="date" required="true"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col">
                                <div class="col md-form">
                                    <label><span class="red-text">* </span>Job Description</label>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <div class="col md-form">
                                    <label><span class="red-text">* </span>Job Responsibilities</label>
                    ...
                    <div class="card-footer justify-content-around text-center">
                        ...
                        <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-blue" Text="Post Job" OnClick="btnSubmit_Click" />
                    </div>
                </div>
            </div>
        </div>
