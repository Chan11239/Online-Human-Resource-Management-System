...
namespace OHRMS.Employees
{
    public partial class LeaveApprove : AbstractWebPage
    {
        ...
        {
            populateDepartment();
            string query = "SELECT a.id, a.employeeNo, a.employeeName, a.reasons, a.department, a.startDate, a.endDate, a.status, b.leaveTypeCode, b.leaveTypeName " +
            ...
            {
                query += "OR a.employeeNo LIKE '%" + searchValue + "%' " +
